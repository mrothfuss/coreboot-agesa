...
//#define BLDOPT_REMOVE_HW_DQS_REC_EN_SEED_TRAINING TRUE
 ...
 *
 */
CONST SYSTEM_PHYSICAL_SOCKET_MAP ROMDATA kgpe_d16_socket_map[] =
{
#define HT_SOCKET0	0
#define HT_SOCKET1	1
#define HT_SOCKET2	2
...
//#define BLDCFG_SYSTEM_PHYSICAL_SOCKET_MAP	&kgpe_d16_socket_map
...
#define F15_WL_UDIMM_SEED  0x0F
#define F15_WL_RDIMM_SEED  0x41
#define F15_WL_LRDIMM_SEED 0x00
#define F15_RX_UDIMM_SEED_A  0x51
#define F15_RX_UDIMM_SEED_B  0x4A
#define F15_RX_UDIMM_SEED_C  0x46
#define F15_RX_UDIMM_SEED_D  0x3F
#define F15_RX_RDIMM_SEED_A  0x54
#define F15_RX_RDIMM_SEED_B  0x4D
#define F15_RX_RDIMM_SEED_C  0x45
#define F15_RX_RDIMM_SEED_D  0x40
#define F15_RX_LRDIMM_SEED_A 0x132
#define F15_RX_LRDIMM_SEED_B 0x122
#define F15_RX_LRDIMM_SEED_C 0x112
#define F15_RX_LRDIMM_SEED_D 0x102
...
CONST PSO_ENTRY ROMDATA DefaultPlatformMemoryConfiguration[] = {
	 ...
	 *                     ByteEccSeed)
	 */
	WRITE_LEVELING_UDIMM_SEED(
			ANY_SOCKET, ANY_CHANNEL, ALL_DIMMS,
			F15_WL_UDIMM_SEED, F15_WL_UDIMM_SEED, F15_WL_UDIMM_SEED, F15_WL_UDIMM_SEED,
			F15_WL_UDIMM_SEED, F15_WL_UDIMM_SEED, F15_WL_UDIMM_SEED, F15_WL_UDIMM_SEED,
			F15_WL_UDIMM_SEED),
	WRITE_LEVELING_RDIMM_SEED(
			ANY_SOCKET, ANY_CHANNEL, ALL_DIMMS,
			F15_WL_RDIMM_SEED, F15_WL_RDIMM_SEED, F15_WL_RDIMM_SEED, F15_WL_RDIMM_SEED,
			F15_WL_RDIMM_SEED, F15_WL_RDIMM_SEED, F15_WL_RDIMM_SEED, F15_WL_RDIMM_SEED,
			F15_WL_RDIMM_SEED),
	WRITE_LEVELING_LRDIMM_SEED(
			ANY_SOCKET, ANY_CHANNEL, ALL_DIMMS,
			F15_WL_LRDIMM_SEED, F15_WL_LRDIMM_SEED, F15_WL_LRDIMM_SEED, F15_WL_LRDIMM_SEED,
			F15_WL_LRDIMM_SEED, F15_WL_LRDIMM_SEED, F15_WL_LRDIMM_SEED, F15_WL_LRDIMM_SEED,
			F15_WL_LRDIMM_SEED),
	...
	HW_RXEN_UDIMM_SEED(
		...
		F15_RX_UDIMM_SEED_A, F15_RX_UDIMM_SEED_A, F15_RX_UDIMM_SEED_A, F15_RX_UDIMM_SEED_A,
		F15_RX_UDIMM_SEED_A, F15_RX_UDIMM_SEED_A, F15_RX_UDIMM_SEED_A, F15_RX_UDIMM_SEED_A,
		F15_RX_UDIMM_SEED_A),
	HW_RXEN_UDIMM_SEED(
		ANY_SOCKET, CHANNEL_B, ALL_DIMMS,
		F15_RX_UDIMM_SEED_B, F15_RX_UDIMM_SEED_B, F15_RX_UDIMM_SEED_B, F15_RX_UDIMM_SEED_B,
		F15_RX_UDIMM_SEED_B, F15_RX_UDIMM_SEED_B, F15_RX_UDIMM_SEED_B, F15_RX_UDIMM_SEED_B,
		F15_RX_UDIMM_SEED_B),
	HW_RXEN_UDIMM_SEED(
		ANY_SOCKET, CHANNEL_C, ALL_DIMMS,
		F15_RX_UDIMM_SEED_C, F15_RX_UDIMM_SEED_C, F15_RX_UDIMM_SEED_C, F15_RX_UDIMM_SEED_C,
		F15_RX_UDIMM_SEED_C, F15_RX_UDIMM_SEED_C, F15_RX_UDIMM_SEED_C, F15_RX_UDIMM_SEED_C,
		F15_RX_UDIMM_SEED_C),
	HW_RXEN_UDIMM_SEED(
		ANY_SOCKET, CHANNEL_D, ALL_DIMMS,
		F15_RX_UDIMM_SEED_D, F15_RX_UDIMM_SEED_D, F15_RX_UDIMM_SEED_D, F15_RX_UDIMM_SEED_D,
		F15_RX_UDIMM_SEED_D, F15_RX_UDIMM_SEED_D, F15_RX_UDIMM_SEED_D, F15_RX_UDIMM_SEED_D,
		F15_RX_UDIMM_SEED_D),
	HW_RXEN_RDIMM_SEED(
		ANY_SOCKET, CHANNEL_A, ALL_DIMMS,
		F15_RX_RDIMM_SEED_A, F15_RX_RDIMM_SEED_A, F15_RX_RDIMM_SEED_A, F15_RX_RDIMM_SEED_A,
		F15_RX_RDIMM_SEED_A, F15_RX_RDIMM_SEED_A, F15_RX_RDIMM_SEED_A, F15_RX_RDIMM_SEED_A,
		F15_RX_RDIMM_SEED_A),
	HW_RXEN_RDIMM_SEED(
		ANY_SOCKET, CHANNEL_B, ALL_DIMMS,
		F15_RX_RDIMM_SEED_B, F15_RX_RDIMM_SEED_B, F15_RX_RDIMM_SEED_B, F15_RX_RDIMM_SEED_B,
		F15_RX_RDIMM_SEED_B, F15_RX_RDIMM_SEED_B, F15_RX_RDIMM_SEED_B, F15_RX_RDIMM_SEED_B,
		F15_RX_RDIMM_SEED_B),
	HW_RXEN_RDIMM_SEED(
		ANY_SOCKET, CHANNEL_C, ALL_DIMMS,
		F15_RX_RDIMM_SEED_C, F15_RX_RDIMM_SEED_C, F15_RX_RDIMM_SEED_C, F15_RX_RDIMM_SEED_C,
		F15_RX_RDIMM_SEED_C, F15_RX_RDIMM_SEED_C, F15_RX_RDIMM_SEED_C, F15_RX_RDIMM_SEED_C,
		F15_RX_RDIMM_SEED_C),
	HW_RXEN_RDIMM_SEED(
		ANY_SOCKET, CHANNEL_D, ALL_DIMMS,
		F15_RX_RDIMM_SEED_D, F15_RX_RDIMM_SEED_D, F15_RX_RDIMM_SEED_D, F15_RX_RDIMM_SEED_D,
		F15_RX_RDIMM_SEED_D, F15_RX_RDIMM_SEED_D, F15_RX_RDIMM_SEED_D, F15_RX_RDIMM_SEED_D,
		F15_RX_RDIMM_SEED_D),
	HW_RXEN_LRDIMM_SEED(
		ANY_SOCKET, CHANNEL_A, ALL_DIMMS,
		F15_RX_LRDIMM_SEED_A, F15_RX_LRDIMM_SEED_A, F15_RX_LRDIMM_SEED_A, F15_RX_LRDIMM_SEED_A,
		F15_RX_LRDIMM_SEED_A, F15_RX_LRDIMM_SEED_A, F15_RX_LRDIMM_SEED_A, F15_RX_LRDIMM_SEED_A,
		F15_RX_LRDIMM_SEED_A),
	HW_RXEN_LRDIMM_SEED(
		ANY_SOCKET, CHANNEL_B, ALL_DIMMS,
		F15_RX_LRDIMM_SEED_B, F15_RX_LRDIMM_SEED_B, F15_RX_LRDIMM_SEED_B, F15_RX_LRDIMM_SEED_B,
		F15_RX_LRDIMM_SEED_B, F15_RX_LRDIMM_SEED_B, F15_RX_LRDIMM_SEED_B, F15_RX_LRDIMM_SEED_B,
		F15_RX_LRDIMM_SEED_B),
	HW_RXEN_LRDIMM_SEED(
		ANY_SOCKET, CHANNEL_C, ALL_DIMMS,
		F15_RX_LRDIMM_SEED_C, F15_RX_LRDIMM_SEED_C, F15_RX_LRDIMM_SEED_C, F15_RX_LRDIMM_SEED_C,
		F15_RX_LRDIMM_SEED_C, F15_RX_LRDIMM_SEED_C, F15_RX_LRDIMM_SEED_C, F15_RX_LRDIMM_SEED_C,
		F15_RX_LRDIMM_SEED_C),
	HW_RXEN_LRDIMM_SEED(
		ANY_SOCKET, CHANNEL_D, ALL_DIMMS,
		F15_RX_LRDIMM_SEED_D, F15_RX_LRDIMM_SEED_D, F15_RX_LRDIMM_SEED_D, F15_RX_LRDIMM_SEED_D,
		F15_RX_LRDIMM_SEED_D, F15_RX_LRDIMM_SEED_D, F15_RX_LRDIMM_SEED_D, F15_RX_LRDIMM_SEED_D,
		F15_RX_LRDIMM_SEED_D),
